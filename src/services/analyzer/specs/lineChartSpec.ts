/**
 * Line Chart Spec Generator
 */

import type { ChartConfig, MatrixResultData } from '../../../types';

/**
 * Generate ECharts line chart configuration from matrix data
 */
export function generateLineChartSpec(data: MatrixResultData): ChartConfig {
